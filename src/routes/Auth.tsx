...
export function Auth() {
    ...
    if (error) {
        return <div className="vh100 gap-3 d-flex flex-center flex-center-items text-light flex-column">
    ...
    return <div className="vh100 gap-3 d-flex flex-center flex-center-items">
